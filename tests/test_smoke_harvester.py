...
_make_stub('eupmc_api', {'search_eupmc': lambda q, y, n: [], 'fetch_fulltext_jats': lambda pmc: None})
_make_stub('unpaywall_api', {'unpaywall_lookup': lambda doi: {}})
_make_stub('grobid_client', {'pdf_to_tei': lambda url, b: None})
_make_stub('tei_utils', {'tei_to_sections': lambda t: [], 'filter_methods_sections': lambda s: []})
_make_stub('jats_utils', {'jats_to_sections': lambda j: [], 'filter_methods_sections': lambda s: []})
_make_stub('oa_resolver', {'resolve_oa': lambda doi: {'is_oa': False}})
_make_stub('enhanced_relevance', {'enhance_harvester_relevance': lambda papers, cfg: papers})
