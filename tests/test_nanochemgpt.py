...
def test_server():
    ...
    pytest.skip("Test server not available. Start the application before running tests.")
...
class TestFileUpload:
    ...
    def test_text_file_upload(self, test_server, sample_protocol):
        ...
        with open(sample_protocol, 'rb') as f:
            ...
            data = {
                'question': 'Analyze this synthesis protocol',
                'mode': 'reasoning'
            }
    ...
    def test_verbatim_extraction(self, test_server, sample_protocol):
        ...
        with open(sample_protocol, 'rb') as f:
            files = {'file': ('sample_protocol.txt', f, 'text/plain')}
            data = {
                'question': 'Quote the procedure verbatim',
                'mode': 'protocol'
            }
